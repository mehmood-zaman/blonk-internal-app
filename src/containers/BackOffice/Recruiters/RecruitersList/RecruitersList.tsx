...
const RecruitersList: React.FC = () => {
  ...
  useEffect(() => {
    setFakeData({
      ...fakeData,
      recruiterRecord: [...generateUsers(20, url).users],
    });
    setTimeout(function () {
      setLoading(false);
    }, 1000);
  ...
  const columns: ColumnsType<Recruiters> = [
    ...
    },
    {
      ...
      dataIndex: 'id',
      width: 100,
      render: (id, row) => companiesHandler(id, row.companyCount),
  ...
  return (
    <>
      <PageTitle
        ...
        btnActive={true}
      />
      {!loading && !fakeData.recruiterRecord ? (
        <ErrorCard />
      ) : (
                ...
                <Tabs defaultActiveKey="1">
                  ...
                  >
                    <Table<Recruiters>
                      ...
                      columns={columns}
                      dataSource={fakeData.recruiterRecord}
                      loading={loading}
                      size="small"
